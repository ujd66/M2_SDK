...
public:
    ...
    virtual  int upload(QADocResult* result,const char* uri,std::vector<std::string> tags) const     = 0;
    virtual  int deleteByID(QADocResult* result,std::vector<std::string> ids) const    = 0;
    virtual  int deleteAll(QADocResult* result) const    = 0;
    virtual  int getAllDocs(QADocResult* result) const    = 0;
    virtual  int getDocsByID(QADocResult* result,std::vector<std::string> ids) const    = 0;
    virtual  int getDocsByTag(QADocResult* result,std::vector<std::string> tags) const    = 0;
